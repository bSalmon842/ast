...
.\cmt_preproc.exe > ..\..\code\ast_generated.h
popd
...
echo COMPILING DLL
cl %commonFlagsCompiler% -DTRANSLATION_UNIT_INDEX=0 ..\code\ast.cpp -LD /link %commonFlagsLinker% -PDB:game_%random%.pdb -EXPORT:Game_UpdateRender -EXPORT:Game_FillAudioSamples -EXPORT:Game_DebugFrameEnd -EXPORT:Game_InitialiseDebugState
del lock.tmp
